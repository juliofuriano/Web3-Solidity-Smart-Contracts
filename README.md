...
- **03. Interacción entre Contratos (`/03-contratos-conectados`)**:
  ...
  - `Interfaces/IResultado.sol`: Definición de interfaces para desacoplar lógica y permitir llamadas entre contratos.
  - `PayableFunctions/PayableContract.sol` y `PayableContractv2.sol`: Manejo de funciones pagables, recepción de fondos y validaciones de balances.
  - `Comprobadores/requireTest.sol` y `PruebaSeguridad.sol`: Control de flujo, aserciones mediante `require` y pruebas de seguridad en llamadas.
